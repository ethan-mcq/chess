...
public class gameTest {
    ...
    public void testCreateGameSuccess() throws DataAccessException {
        ...
        gameData newGame = new gameData(0, "testGame", chessGame, null, null);
    ...
    public void testGetAllGamesSuccess() throws DataAccessException {
        ...
        gameData game1 = new gameData(0, "testGame1", chessGame1, null, null);
        gameData game2 = new gameData(0, "testGame2", chessGame2, null, null);
